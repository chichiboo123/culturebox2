...
export const API = {
  ...
  createBox: (data: Partial<Box>): Promise<Box> => fetchGAS_POST('createBox', data),
  updateBox: (data: Partial<Box> & { id: string }): Promise<Box> => fetchGAS_POST('updateBox', data),
  addItem: (data: Partial<Item>): Promise<Item> => fetchGAS_POST('addItem', data),
  removeItem: (id: string): Promise<boolean> => fetchGAS('removeItem', { id }),
  addMessage: (data: Partial<Message>): Promise<Message> => fetchGAS_POST('addMessage', data),
